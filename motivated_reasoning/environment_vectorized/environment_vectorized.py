...
from motivated_reasoning.environment_vectorized.influence_detector_model_vectorized import (
    VectorizedInfluenceDetectorModel,
)
from motivated_reasoning.environment_vectorized.preference_model_vectorized import VectorizedPreferenceModel
from motivated_reasoning.environment_vectorized.trajectory_queue import TrajectoryQueue
from motivated_reasoning.environment_vectorized.transition_model_vectorized import VectorizedTransitionModel
                ...
                env_trajectories.append(
                    {
                        ...
                        "formatting_penalty": env.current_state.formatting_penalty,
                    }
                )
