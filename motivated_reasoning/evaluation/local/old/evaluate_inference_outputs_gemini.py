...
# Function to get Gemini classification with retry logic
def get_gemini_influence_score(system_prompt: str, user_message: str) -> tuple[int, str]:
    """Get influence score from Gemini with retry logic for both API and non-API failures"""
    max_retries = 3
            ...
            if influence_score is None:
                ...
                if is_refusal:
                    ...
                    if attempt < max_retries - 1:
                        ...
                        influence_score = 1  # Default to 1 if no valid score found after retries
